...
namespace QuizPortal.Repositories.Sqlite
{
    public class QuizRepository : IQuizRepository
    {
        ...
        // ✅ New method: get only quizzes created by a specific professor
        public async Task<ICollection<Quiz>> GetQuizzesByProfessorAsync(int professorId)
        {
            return await _db.Quizzes
                .Where(q => q.CreatedByProfessorId == professorId)
                .ToListAsync();
        }
